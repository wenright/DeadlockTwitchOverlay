      ...
      {items ?
        <>
          {!isHovered && showWelcomeMessage &&
            <div className='absolute top-0 bottom-0 left-0 right-0 flex items-center p-2 m-6 border-2 rounded-lg pointer-events-none lg:m-8 animate-pulse border-zinc-300'>
